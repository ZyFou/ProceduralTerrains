...
export const SURFACE_PRESETS=[
  {id:'alpine',name:'Alpine',roles:{grass:'ambientcg:Ground037',rock:'polyhaven:rock_boulder_dry',snow:'polyhaven:snow_02'}},
  {id:'forest',name:'Forest',roles:{grass:'polyhaven:forest_ground_04',forest:'polyhaven:forest_leaves_02',rock:'polyhaven:mossy_rock'}},
  {id:'canyon',name:'Canyon',roles:{rock:'pt:canyon-red-stone',rockHi:'polyhaven:rock_face',sand:'polyhaven:sand_03'}},
