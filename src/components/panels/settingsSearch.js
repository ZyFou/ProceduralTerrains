const SETTINGS_INDEX = [
  ...
  { panelId: 'performance', tabId: 'overview', settingId: 'performance.useWorker', label: 'Worker Renderer', keywords: 'offscreen canvas worker renderer ui responsiveness main thread compatibility' },
  ...
  { panelId: 'visuals', tabId: 'camera', settingId: 'visuals.visualsPixelResolution', label: 'Virtual Resolution', keywords: 'visuals camera pixelated resolution 240p ps1' },
  ...
  { panelId: 'visuals', tabId: 'camera', settingId: 'visuals.visualsCrtEnabled', label: 'CRT Camera Shader', keywords: 'visuals camera filter crt scanline curvature chromatic' },
  { panelId: 'visuals', tabId: 'camera', settingId: 'visuals.visualsCrtStrength', label: 'CRT Strength', keywords: 'visuals camera crt intensity scanline noise' },
  { panelId: 'visuals', tabId: 'camera', settingId: 'visuals.visualsCrtLensBend', label: 'CRT Lens Bend', keywords: 'visuals camera crt barrel distortion curve lens bend' },
  { panelId: 'visuals', tabId: 'camera', settingId: 'visuals.visualsCrtLineWidth', label: 'CRT Scanline Width', keywords: 'visuals camera crt scanline width thickness lines' },
  ...
  { panelId: 'clouds', sectionLabel: 'Lighting', settingId: 'clouds.cloudAtmosphereInfluence', label: 'Sky Influence', keywords: 'cloud sky atmosphere lighting color' },
  ...
  { panelId: 'props', sectionLabel: 'Distribution', settingId: 'props.propsTreeDensity', label: 'Tree Density', keywords: 'props trees broadleaf conifer forest density scatter' },
  { panelId: 'props', sectionLabel: 'Look', settingId: 'props.propsGrass', label: 'Grass Height', keywords: 'props grass scale height patch blades biome color' },
  ...
  { panelId: 'props', sectionLabel: 'Look', settingId: 'props.propsTreeScale', label: 'Tree Scale', keywords: 'props trees broadleaf conifer forest size height' },
  ...
  { panelId: 'props', sectionLabel: 'Performance', settingId: 'props.propQuality', label: 'Prop Quality', keywords: 'props quality lod performance grass rocks trees' },
